@testset "Test CLI" begin
    for (args, expected_output) in [
        ...
        (
            ["run"],
            "Usage: monkey run <file> [--vm]\n",
        ),
        (
            ["run", "fixtures/hello_world.m"],
            "ERROR: Only .mo files are supported!\n",
        ),
        (
            ["run", "fixtures/not_exist.mo"],
            "ERROR: File not found!\n",
        ),
        (
            ["run", "fixtures/hello_world.mo"],
            "Hello, world!\n",
        ),
        (
            ["run", "fixtures/hello_world.mo", "--vm"],
            "Hello, world!\n",
        ),
        (
            ["repl"],
